...
from sansldap._pkcs7 import ContentInfo, EnvelopedData, KEKRecipientInfo, RecipientInfo
        ...
        data.update(
            {
                ...
                "KekId": {
                    ...
                    "OtherId": info.kekid.other.key_attr_id,
                    "OtherValue": base64.b16encode(info.kekid.other.key_attr).decode(),
                },
                "Algorithm": {
